...
export const BurgerIngredients: React.FC<BurgerIngredientsProps> = ({ ingredients, setIngredients }) => {
    ...
    return (
        <div className={s.container}>
            ...
            <div className="pb-10" style={{ display: 'flex' }}>
                <Tab value="one" active={current === 'one'} onClick={() => { setCurrent('one'); scrollToSection(bunsRef); }}>
                    Булки
                </Tab>
                <Tab value="two" active={current === 'two'} onClick={() => { setCurrent('two'); scrollToSection(saucesRef); }}>
                    Соусы
                </Tab>
                <Tab value="three" active={current === 'three'} onClick={() => { setCurrent('three'); scrollToSection(fillingsRef); }}>
                    Начинки
                </Tab>
            </div>
                ...
                <Droppable droppableId="ingredients" isDropDisabled={true}>
                    {(provided) => (
                        <div ref={provided.innerRef} {...provided.droppableProps}>
                            ...
                            <h2 ref={fillingsRef} className="text text_type_main-medium">Начинки</h2>
                            <div className={s.ingredientRow}>
